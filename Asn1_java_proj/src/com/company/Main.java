...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double dataArray[] = new double[myMAX];
        //index
        int itemCount = 0;
        double median = 0;
        double mean = 0;
        double mode = 0;
        double total = 0;
        // make varibles to store value for median
        int mdnHigh = 0;
        int mdnLow = 0;
        ...
        try {
            ...
            for(int i=0; i < myMAX; i++) {
                ...
                if (scanUserFile.hasNext()) {
                    ...
                    dataArray[itemCount] = scanUserFile.nextDouble();
            ...
            // display array by looping over all of the items
            // display data from file ascending 0 to ....
            for(int i = 0;  i < myMAX; i++) {
                System.out.print(" | " + dataArray[i]);
            }
            /*
            for(int i = (myMAX - itemCount);  i < myMAX; i++) {
                System.out.print(" | " + dataArray[i]);
            }
*/
            //keep format symmetrical
            System.out.print(" |");
            System.out.print("\n");
            ...
            // ---------------------------------------------
            // Calculate the Mean
            mean = total / itemCount;
            // Calculate the Median

            if(itemCount % 2 == 0){

               // calculate median
                mdnHigh = (itemCount / 2) + (myMAX  - itemCount) ;
                mdnLow = mdnHigh - 1;

                System.out.println(" low " + dataArray[mdnLow] + " high " + dataArray[mdnHigh]);

               median = (dataArray[mdnLow] + dataArray[mdnHigh]) / 2 ;
            ...
            System.out.printf("\tMean:.................. %20.2f\n", mean);
            System.out.printf("\tMedian:................ %20.2f\n", median);
            System.out.printf("\tMode:.................. %20.2f\n\n", mode);
            System.out.println("==================================================================\n");
            ...
            if ((outputFile.isFile()|| outputFile.canWrite())){
                ...
                outString = "\t\tMean:............... " + mean + NEWLINE + NEWLINE;
                fileOut.write(outString);
